...
const About = () => {
    return (
      ...
      <div className='ad'>
          <span>CURLTAI - нейтральная зона творчества.
            <p>Цель нашего объедения, это продвижение музыкальной культуры 
              в Кыргызстане и не только. В данный момент, мы стали одной из самых 
              доступных площадок для талантливых музыкантов.</p>
            </span>
      </div>
